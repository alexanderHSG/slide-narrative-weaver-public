...
> License: PolyForm Noncommercial License 1.0.0 (`PolyForm-Noncommercial-1.0.0`). This repository is source-available for informational, research, personal, and other noncommercial use only. Commercial use requires separate permission from the copyright holder.
...
This is not an open-source license. The code is published for reading, evaluation, research, and other permitted noncommercial uses.

Commercial use is not permitted under the repository license. If you want commercial rights, contact the copyright holder for a separate agreement.
